...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <ul class="list-group mb-3">
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        <h6 class="my-0">{{$ca['title']}}</h6>
                        <small class="text-muted">Brief description</small>
                    </div>
                    <span class="text-muted">{{$ca['price'] * $ca['quantity']}}</span>
                </li>
                @php $total += $ca['price'] * $ca['quantity']; @endphp
                @endforeach
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form class="needs-validation" action="{{ route("complete.order") }}" method="post">
                @csrf
                <div class="row">
